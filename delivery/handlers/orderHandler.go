...
func (oh *OrderHandler) PaymentVerification(c *gin.Context) {
...
func (oh *OrderHandler) OrderReturn(c *gin.Context) {
	userID, _ := c.Get("userID")
	userId := userID.(int)
	strOrderId := c.Param("orderid")
...
func (oh *OrderHandler) AdminOrderUpdate(c *gin.Context) {
	strOrderId := c.Param("orderid")
	orderId, err := strconv.Atoi(strOrderId)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "str conversion failed"})
...
func (oh *OrderHandler) AdminReturnUpdate(c *gin.Context) {
...
func (oh *OrderHandler) AdminRefund(c *gin.Context) {
...
func (oh *OrderHandler) SalesReportByDate(c *gin.Context) {
...
func (oh *OrderHandler) SalesReportByPeriod(c *gin.Context) {
...
func (oh *OrderHandler) SalesReportByCategory(c *gin.Context) {
